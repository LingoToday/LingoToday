        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Button 
                variant="outline"
                className="border-gray-300 text-gray-700 font-medium px-3 sm:px-4 py-2 rounded-full hover:bg-gray-50 text-[12px]"
              ...
              >
                <span className="hidden sm:inline text-[12px]">Use For Free</span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">Micro language lessons on your phone or laptop - backed by science.</h1>
            
            <div className="mb-8 max-w-3xl lg:max-w-none">
              <div className="text-xl text-gray-600 space-y-4">
                <p>Micro lessons delivered by notifications to your laptop or phone. Using official CEFR course structures.</p>
              </div>
            </div>
