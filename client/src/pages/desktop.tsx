        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Button 
                variant="outline"
                className="border-gray-300 text-gray-700 font-medium px-3 sm:px-4 py-2 rounded-full hover:bg-gray-50 text-[14px] sm:text-base"
              ...
              >
                <span className="hidden sm:inline text-[14px]">Try 3 Months Free</span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mb-8 max-w-3xl lg:max-w-none">
              <div className="text-xl text-gray-600 space-y-4">
                <p>Short micro lessons delivered by browser notifications to your laptop, discreetly throughout your work day. Using learning methods backed by science.</p>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="text-center">
            <h2 className="md:text-4xl font-bold text-gray-900 mb-8 text-[32px]">Unlock 3 months free as part of our launch offer! </h2>
            <Button 
              size="lg"
