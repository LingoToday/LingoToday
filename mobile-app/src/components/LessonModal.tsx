...
export default function LessonModal({ 
  ...
  const renderPhase2 = () => (
    <View style={styles.phaseContainer}>
      ...
      {showPhase2Result && !phase2Correct && (
        <View style={styles.resultCard}>
          <Text style={styles.resultText}>
            Correct answer: {(lesson.quiz?.options || [lesson.content.word])[lesson.quiz?.correct || 0]}
          </Text>
        </View>
      )}
  ...
  const renderPhase3 = () => (
    <View style={styles.phaseContainer}>
      ...
      {showPhase3Result && !phase3Correct && (
        <View style={styles.resultCard}>
          <Text style={styles.resultText}>
            Correct answer: {getMissingLetters(lesson.content.word)}
          </Text>
        </View>
      )}
  ...
  const renderPhase4 = () => (
    <View style={styles.phaseContainer}>
      ...
      {showPhase4Result && !phase4Correct && (
        <View style={styles.resultCard}>
          <Text style={styles.resultText}>
            Correct answer: {lesson.content.translation}, hi!
          </Text>
        </View>
      )}
